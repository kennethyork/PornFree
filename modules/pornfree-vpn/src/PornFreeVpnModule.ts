...
import type {
  ...
  ProtectionStatus,
  UninstallState,
} from './PornFreeVpn.types';

declare class PornFreeVpnModule extends NativeModule<PornFreeVpnModuleEvents> {
...
export default requireNativeModule<PornFreeVpnModule>('PornFreeVpn');
