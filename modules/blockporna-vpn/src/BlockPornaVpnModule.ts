...
import type {
  BlocklistInfo,
  BlockPornaVpnModuleEvents,
  DailyStats,
  ProtectionConfig,
  ProtectionStatus,
  UninstallState,
} from './BlockPornaVpn.types';

declare class BlockPornaVpnModule extends NativeModule<BlockPornaVpnModuleEvents> {
...
export default requireNativeModule<BlockPornaVpnModule>('BlockPornaVpn');
